...
const displayMovements = function (acc, sort = false) {
  ...
  movs.forEach(function (mov, i) {
    ...
    let displayDates = new Intl.DateTimeFormat(`${acc.locale}`, options).format(
      now
    );
    ...
    if (dayPassed === 1) {
      displayDates = 'yesterday';
    }
    if (dayPassed <= 7 && dayPassed > 1) {
      displayDates = `${dayPassed}days`;
    }
...
//   (ing1, ing2) => console.log('pizza' + ing1 + ' ' + ing2),
//   3000,
//   ...ing
// );
